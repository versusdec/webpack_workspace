...
var _menuComponent = __webpack_require__(32);

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

var menuItems1 = ['Создание сайтов', 'Изготовление сайтов «под ключ»', 'Как мы работаем ', 'Интеграция с 1C', 'Поддержка сайтов', 'Создание сайтов на Битрикс', 'Модули Битрикс', 'Купить Битрикс', 'Дизайн сайтов', 'Редизайн сайтов', 'Интернет маназины', 'Создание логотипов'];
...
var menuItems3 = ['Поисковое продвижение сайтов', 'Тариф «Старт»', 'Тариф «Продвижение Агонь!»', 'Тариф «Интернет-магазин»', 'Тариф «Эксклюзив»', 'Тариф «Контекст + SEO»', 'Тариф «Регион»'];

var menuItemSpan = [];
menuItems3.forEach(function (item) {
        var spanCoveredItem = React.createElement(
                'span',
                null,
                item
        );
...
(0, _reactDom.render)(React.createElement(_menuComponent.SideMenu, { items: menuItems1 }), document.querySelector('.menu'));
(0, _reactDom.render)(React.createElement(_menuComponent.SideMenu, { items: menuItemsGen() }), document.querySelector('.footer-menu1'));
(0, _reactDom.render)(React.createElement(_menuComponent.SideMenu, { items: menuItemSpan }), document.querySelector('.footer-menu2'));
