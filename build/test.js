...
(0, _jquery2.default)(document).ready(function () {
    (0, _jquery2.default)('.custom').SumoSelect();
});
(0, _jquery2.default)(document).ready(function () {
    (0, _jquery2.default)('.custom2').SumoSelect();
});
...
function modalHandler() {
    var modalHandler = document.querySelector('.modal_brief');
    modalHandler.classList.toggle('active');
    var closeModal = modalHandler.querySelector('.brief-modal-box__close');

    closeModal.addEventListener('click', function () {
        modalHandler.classList.remove('active');
    });
    (0, _jquery2.default)('.modal_brief').click(function (event) {
        if (!(0, _jquery2.default)(event.target).closest(".brief_modal_wrapp_inside").length) {
            modalHandler.classList.remove("active");
        }
    });
}

if ((0, _jquery2.default)('.modal_brief').length) {
    var renderItems = function renderItems(item) {
        ...
        (0, _jquery2.default)(label).append(input, span);
        return label;
    };

    var modal = document.querySelector('.brief_modal_wrapp_inside');
    var inputHandler = modal.querySelectorAll('.input_wrapper');
    var inputItems = [];
    ...
    var itemsArr = ['item 1', 'item 2', 'some another very cool item', 'amazing item', 'super puper crazy item', 'test', 'test', 'test', 'test', 'test', 'test', 'shut up and take my money bitch', 'maybe enough?', 'i need more items!!', 'more more more massive mammoth mega items', 'item 100500', 'item 1', 'item 2', 'some another very cool item', 'amazing item', 'super puper crazy item', 'test', 'test', 'test', 'test', 'test', 'test', 'shut up and take my money bitch', 'maybe enough?', 'i need more items!!', 'more more more massive mammoth mega items', 'item 100500'];
    var target = modal.querySelector('.add_products');
