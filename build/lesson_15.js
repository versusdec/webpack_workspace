...
var _commentsForm = __webpack_require__(53);

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

(0, _reactDom.render)(React.createElement(_commentsForm.CommentsForm, null), document.querySelector('.comment-list'));
...
*/
var aa=__webpack_require__(5),ba=__webpack_require__(1),m=__webpack_require__(10),p=__webpack_require__(4),v=__webpack_require__(3),da=__webpack_require__(11),ea=__webpack_require__(12),fa=__webpack_require__(13),ha=__webpack_require__(6);
...
var _commentsListComponent = __webpack_require__(55);

var _inputFormComponent = __webpack_require__(58);

var _idGenerator = __webpack_require__(14);
...
var URL = 'https://evening-dawn-11092.herokuapp.com';
...
var CommentsForm = exports.CommentsForm = function (_React$Component) {
    ...
    function CommentsForm() {
        ...
        var _this = _possibleConstructorReturn(this, (CommentsForm.__proto__ || Object.getPrototypeOf(CommentsForm)).call(this));

        _this.state = {
            list: []
        };
        _ajax.Ajax.get(COMMENTS, function (resp) {
    ...
    _createClass(CommentsForm, [{
        ...
        key: 'submitForm',
        value: function submitForm(author, text) {
            var _this2 = this;

            _ajax.Ajax.post(COMMENTS, { text: text, author: author }, function (resp) {
                _this2.add(resp);
            });
        }
    }, {
        ...
        value: function update(item) {
            ...
            _ajax.Ajax.put(COMMENTS + '/' + item.id, item, function (elem) {
        ...
        key: 'delete',
        value: function _delete(delElem) {
            var _this4 = this;

            _ajax.Ajax.delete(COMMENTS + '/' + delElem.id, function () {
                var updatedList = _this4.state.list.filter(function (elem) {
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(_inputFormComponent.InputForm, { onSubmit: this.submitForm.bind(this) }),
                React.createElement(_commentsListComponent.CommentsList, { items: this.state.list, onDelete: this.delete.bind(this), onChange: this.update.bind(this) })
            );
        }
    }]);
...
var Ajax = exports.Ajax = function () {
    ...
    _createClass(Ajax, null, [{
        ...
        key: 'post',
        value: function post(url, data, callbackFunction) {
            var xhr = new XMLHttpRequest();
            xhr.open('POST', url);
...
var _commList = __webpack_require__(56);
...
var CommentsList = exports.CommentsList = function (_React$Component) {
    ...
    function CommentsList() {
        ...
        return _possibleConstructorReturn(this, (CommentsList.__proto__ || Object.getPrototypeOf(CommentsList)).call(this));
    }
    ...
    _createClass(CommentsList, [{
        ...
        value: function render() {
            ...
            var comments = this.props.items.map(function (itemListObj) {
                return React.createElement(_commList.ItemList, { onDelete: _this2.onDelete.bind(_this2), onChange: _this2.onItemChange.bind(_this2), key: (0, _idGenerator.ID)(), items: itemListObj });
            });

            return React.createElement(
                'div',
                { key: (0, _idGenerator.ID)(), className: 'comments' },
                comments
            );
        }
    }]);
...
var _editorComponent = __webpack_require__(57);
...
var DUMMYTEXT = 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore atque qui commodi, reiciendis omnis nisi voluptatem error sit illum quidem! Quibusdam, est totam atque natus in mollitia odio fugit impedit?';
...
var ItemList = exports.ItemList = function (_React$Component) {
    ...
    _createClass(ItemList, [{
        ...
        value: function edit(element) {
            var item = Object.assign({}, this.props.items);
            var target = element.target.parentElement;
            (0, _reactDom.render)(React.createElement(_editorComponent.Editor, { item: item /* value={item.text} */, onSubmit: this.onChange.bind(this) }), target);
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'button',
                        { onClick: this.onDelete.bind(this), className: 'comments__delete' },
                        React.createElement('i', { className: 'far fa-trash-alt' })
                    ),
                    React.createElement('button', { onClick: this.edit.bind(this), className: 'comments__edit far fa-edit' })
                )
            );
        }
    }]);
    ...
    _createClass(Editor, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement('textarea', { className: 'editor', value: this.state.value, onChange: this.changedText.bind(this) }),
                React.createElement('input', { className: 'editor__button', type: 'submit', value: 'SAVE' })
            );
        }
    }]);
...
var InputForm = exports.InputForm = function (_React$Component) {
    ...
    _createClass(InputForm, [{
        ...
        value: function render() {
            return React.createElement(
                'form',
                { className: 'comment-input', id: 'comments', onSubmit: this.submitHandler.bind(this) },
                React.createElement('input', { type: 'text', value: this.state.author, onInput: this.inputHandler.bind(this), className: 'comment-input__author' }),
                React.createElement('textarea', { value: this.state.text, className: 'comment-input__text', onInput: this.inputHandler.bind(this) }),
                React.createElement('input', { type: 'submit', form: 'comments', value: 'SUBMIT', className: 'comment-input__submit' })
            );
        }
    }]);
